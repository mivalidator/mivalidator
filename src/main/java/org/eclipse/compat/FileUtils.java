...
public final class FileUtils {
	...
	private static String WORK_DIRECTORY_PREFIX = "mivalidator-" + System.currentTimeMillis();
    ...
    public static Path newTempPath() throws IOException {
		synchronized (lock) {
 			if (workDirectory == null) {
				workDirectory = createTempDirectory(WORK_DIRECTORY_PREFIX);
			}
